          ...
          <div className="w-full max-w-[520px]">
            ...
            <div className="mb-8 lg:hidden">
              <div className="text-center">
                <Image
                  ...
                  width={300}
                  height={300}
                  className="mx-auto h-auto w-full max-w-[300px] object-contain object-bottom"
                />
              </div>
            </div>
            ...
            <div className="mb-6 text-center">
              ...
              <p className="mt-3 leading-7 text-[#6B7280]">
                Sign in to continue discovering something special.
              </p>
            </div>

            {/* Email / Mobile Toggle */}
            <div className="mb-5 grid grid-cols-2 rounded-2xl bg-[#F8F6F4] p-1">
              <button
                type="button"
                onClick={() => {
                  setLoginWith("email");
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex justify-end">
                <Link
                  ...
                  className="text-sm font-medium text-[#FF5A5F] transition hover:underline"
                >
                  Forgot Password?
                </Link>
              </div>
          ...
          <div className="relative z-10 flex h-full w-full flex-col px-14 py-16 xl:px-20">
            ...
            <div className={`${poppins.className} max-w-lg`}>
              ...
              <p className="mt-6 pl-10 text-base leading-8 font-medium text-white/85">
                Your next perfect gift is waiting.
                <br />
                Discover thoughtful surprises for
                <br />
